...
var/list/global_sidormat_list = list(
	...
	"Suits" = list(
		...
		new	/datum/data/stalker_equipment("Exoskeleton",				"Exoskeleton",				/obj/item/clothing/suit/hooded/sealed/exoskelet,			806000,		EXPERT,	faction = "Military"),
	...
	"Misc" = list(
		...
		new /datum/data/stalker_equipment("USMC Warbelt",						"USMC Warbelt",							/obj/item/weapon/storage/belt/military/webbing/warbelt,			40000,	EXPERIENCED,	faction = "Mercenaries"),
